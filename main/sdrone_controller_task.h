...
#define SDRONE_MOTORS_RANGE_OFFSET 0.0f //1.48f
#define SDRONE_NORM_THROTTLE_TO_ACCEL_FACTOR (((float)MOTORS_ACCEL_RANGE - SDRONE_MOTORS_RANGE_OFFSET)/(float)SDRONE_RC_CHANNEL_RANGE)
